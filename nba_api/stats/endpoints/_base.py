...
class Endpoint:
    ...
    class DataSet:
        ...
        def get_data_frame(self):
            ...
            if len(self.data['headers']) > 0 and isinstance(self.data['headers'][0], str):
    ...
    def get_data_frames(self):
        return [data_set.get_data_frame() for data_set in self.data_sets if len(data_set.data['headers']) > 0]
